...
@@markdown:![The packaging gradient, from the [Hashemi PyBay'17](https://www.youtube.com/watch?v=iLVNWfPWAC8) and [Goswami PyCon 2020](https://rgoswami.me/posts/pycon-in-2020-meta) presentation](fig/The_Installation_Problem/2026-02-11_06-21-53_screenshot.png)@@
...
We will use *uv*, a convenient, modern Python package manager, which also
